...
function proxyRequest(req, res, proxy) {
  ...
  console.log(JSON.stringify(req.headers));
   console.log(res.getHeader('accept-language'));
   
  if (res.getHeader('accept-language'))
  {
      var delayTime = parseInt(res.getHeader('accept-language'));
      delete req.headers['accept-language'];
      setTimeout(function(){ proxy.web(req, res, proxyOptions); },delayTime);  
