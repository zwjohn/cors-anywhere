...
console.log('PROXY IS BEING CALLED..');
  ...
  return function(req, res) {
   // var auth = req.headers['Authorization'];
    ...
    if (req.method === 'OPTIONS') {
      ...
      console.log('PREFLIGHT Request Served..');
   ...
   // res.header("Access-Control-Allow-Headers", req.header('access-control-request-headers'));
    ...
    console.log('NOT a Preflight..');
   // if (auth){
     req.headers['Authorization'] = '00D36000000j4bG!AQQAQBFBGtCEergkUS5zIgy4BAG0rcECnRSlmdRsvHrvDbQoczhHO58gPBlD6bgkoxC1AsH1mSDrgJDJbKGtgyDS0yisEAh2';
